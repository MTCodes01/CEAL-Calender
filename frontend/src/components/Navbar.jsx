                ...
                <div className="flex items-center gap-3">
                  <div className="hidden sm:flex flex-col items-end justify-center">
                    ...
                    <div className="flex gap-1 mt-1">
                      {user.club && (
                        <span 
                          className="text-[9px] font-extrabold px-1.5 py-0.5 rounded-[24px] shadow-sm uppercase tracking-wider text-white"
                  ...
                  <button
                    ...
                    title="Logout"
                    className="ml-1 p-2 text-gray-500 hover:text-red-600 hover:bg-red-50 dark:text-gray-400 dark:hover:text-red-400 dark:hover:bg-red-900/20 rounded-lg transition-all duration-200 flex-shrink-0"
                  >
